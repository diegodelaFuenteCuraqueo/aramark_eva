      ...
      <div className="home-element">
        ...
        <div className="text-center home-element">
          <div className="course-element-description">
            <p>
            La ruta de aprendizaje que verás a continuación fue construida utilizando inteligencia artificial (IA) y se basa en tus intereses profesionales expresados en el formulario de registro.
            </p>
            <p>
